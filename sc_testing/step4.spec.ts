...
import { TestContract } from "./TestContract"; // this is the interface class from tutorial 2
...
describe("Counter tests", () => {
    ...
    beforeEach(async () => {
        ...
        const counterCode = Cell.fromBoc(fs.readFileSync("test_contract.cell"))[0]; // compilation output from tutorial 2
        const initialCounterValue = 17; // no collisions possible since sandbox is a private local instance
        const counter = TestContract.createForDeploy(counterCode, initialCounterValue);
