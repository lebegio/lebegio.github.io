...
const uintOptions = Object.fromEntries([...Array(257).keys()]
    .slice(1)
    .map((key) => [`uint${key}`, { type: "uint", format: key }]));
const intOptions = Object.fromEntries([...Array(257).keys()]
    .slice(1)
...
exports.intMapFormats = { ...intFormats };
const cellFormats = {
    ...
    if (src.type.kind === "map_type") {
        ...
        if ((0, ast_1.isInt)(src.type.keyType)) {
            ...
            if (src.type.keyStorageType) {
                const format = exports.intMapFormats[(0, ast_1.idText)(src.type.keyStorageType)];
        ...
        if ((0, ast_1.isInt)(src.type.valueType)) {
            ...
            if (src.type.valueStorageType) {
                const format = exports.intMapFormats[(0, ast_1.idText)(src.type.valueStorageType)];
                if (!format) {
...
function createABITypeRefFromTypeRef(ctx, src, loc) {
    ...
    if (src.kind === "map") {
        ...
        if (src.key === "Int") {
            key = "int";
            if (src.keyAs) {
                const format = exports.intMapFormats[src.keyAs];
        ...
        if (src.value === "Int") {
            value = "int";
            if (src.valueAs) {
                const format = exports.intMapFormats[src.valueAs];
                if (!format) {
