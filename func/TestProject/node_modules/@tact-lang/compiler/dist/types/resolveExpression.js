...
function resolveStaticCall(exp, sctx, ctx) {
    ...
    if (!(0, resolveDescriptors_1.hasStaticFunction)(ctx, (0, ast_1.idText)(exp.function))) {
        ...
        if ((0, resolveDescriptors_1.getAllTypes)(ctx).find((ty) => ty.functions.get((0, ast_1.idText)(exp.function)) !== undefined) !== undefined) {
            (0, errors_1.throwCompilationError)(`Static function ${(0, errors_1.idTextErr)(exp.function)} does not exist. Perhaps you meant to call ".${(0, ast_1.idText)(exp.function)}(...)" extension function?`, exp.loc);
        }
