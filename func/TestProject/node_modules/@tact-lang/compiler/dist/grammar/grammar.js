...
semantics.addOperation("astOfAsmInstruction", {
    ...
    AsmInstruction_hexLiteral(prefix, digits, optUnderscore, _rbrace, _ws) {
        ...
        if (length > 128) {
            (0, errors_2.throwSyntaxError)("The hex bitstring has more than 128 digits", createRef(this));
        }
    ...
    AsmInstruction_binLiteral(_prefix, digits, _rbrace, _ws) {
        const length = digits.numChildren;
        if (length > 128) {
            (0, errors_2.throwSyntaxError)("The binary bitstring has more than 128 digits", createRef(this));
        }
