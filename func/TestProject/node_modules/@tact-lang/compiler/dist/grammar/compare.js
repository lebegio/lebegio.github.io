...
class AstComparator {
    ...
    compare(node1, node2) {
        ...
        switch (node1.kind) {
            ...
            case "asm_function_def": {
                const { shuffle: shuffle1, attributes: attributes1, name: funcName1, return: returnType1, params: params1, instructions: instructions1, } = node1;
                const { shuffle: shuffle2, attributes: attributes2, name: funcName2, return: returnType2, params: params2, instructions: instructions2, } = node2;
                return (this.compareArray(shuffle1.args, shuffle2.args) &&
    ...
    compareAsmInstructions(instructions1, instructions2) {
