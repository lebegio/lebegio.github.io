...
export declare class PrettyPrinter {
    ...
    ppAstFunctionDef(f: AstFunctionDef): string;
    ppAstAsmFunctionDef(f: AstAsmFunctionDef): string;
    ppAstFunctionDecl(f: AstFunctionDecl): string;
    ppAstFunctionSignature(attributes: AstFunctionAttribute[], name: AstId, retTy: AstType | null, params: AstTypedParameter[]): string;
...
export declare function prettyPrintAsmShuffle(shuffle: AstAsmShuffle): string;
