...
function commentPseudoOpcode(comment) {
...
function writeReceiver(self, f, ctx) {
    const selector = f.selector;
    const selfRes = (0, resolveFuncTypeUnpack_1.resolveFuncTypeUnpack)(self, (0, id_1.funcIdOf)("self"), ctx);
    const selfType = (0, resolveFuncType_1.resolveFuncType)(self, ctx);
    const selfUnpack = `var ${(0, resolveFuncTypeUnpack_1.resolveFuncTypeUnpack)(self, (0, id_1.funcIdOf)("self"), ctx)} = ${(0, id_1.funcIdOf)("self")};`;
    // Binary receiver
    if (selector.kind === "internal-binary" ||
        selector.kind === "external-binary") {
        const args = [
            selfType + " " + (0, id_1.funcIdOf)("self"),
            (0, resolveFuncType_1.resolveFuncType)(selector.type, ctx) + " " + (0, id_1.funcIdOf)(selector.name),
        ];
        ...
        ctx.inIndent(() => {
            ...
            ctx.append(`var ${(0, resolveFuncTypeUnpack_1.resolveFuncTypeUnpack)(selector.type, (0, id_1.funcIdOf)(selector.name), ctx)} = ${(0, id_1.funcIdOf)(selector.name)};`);
    ...
    if (selector.kind === "internal-empty" ||
        ...
        ctx.append(`((${selfType}), ()) ${ops_1.ops.receiveEmpty(self.name, selector.kind === "internal-empty" ? "internal" : "external")}(${selfType + " " + (0, id_1.funcIdOf)("self")}) impure inline {`);
        ctx.inIndent(() => {
            ctx.append(selfUnpack);
            for (const s of f.ast.statements) {
                (0, writeFunction_1.writeStatement)(s, selfRes, null, ctx);
    ...
    if (selector.kind === "internal-comment" ||
        ...
        const hash = commentPseudoOpcode(selector.comment);
        ctx.append(`(${selfType}, ()) ${ops_1.ops.receiveText(self.name, selector.kind === "internal-comment" ? "internal" : "external", hash)}(${selfType + " " + (0, id_1.funcIdOf)("self")}) impure inline {`);
        ctx.inIndent(() => {
            ctx.append(selfUnpack);
            for (const s of f.ast.statements) {
                (0, writeFunction_1.writeStatement)(s, selfRes, null, ctx);
    ...
    if (selector.kind === "internal-comment-fallback" ||
        ...
        ctx.append(`(${selfType}, ()) ${ops_1.ops.receiveAnyText(self.name, selector.kind === "internal-comment-fallback" ? "internal" : "external")}(${[selfType + " " + (0, id_1.funcIdOf)("self"), "slice " + (0, id_1.funcIdOf)(selector.name)].join(", ")}) impure inline {`);
        ctx.inIndent(() => {
            ctx.append(selfUnpack);
            for (const s of f.ast.statements) {
                (0, writeFunction_1.writeStatement)(s, selfRes, null, ctx);
    ...
    if (selector.kind === "internal-fallback") {
        ctx.append(`(${selfType}, ()) ${ops_1.ops.receiveAny(self.name, "internal")}(${selfType} ${(0, id_1.funcIdOf)("self")}, slice ${(0, id_1.funcIdOf)(selector.name)}) impure inline {`);
        ctx.inIndent(() => {
            ctx.append(selfUnpack);
            for (const s of f.ast.statements) {
                (0, writeFunction_1.writeStatement)(s, selfRes, null, ctx);
    ...
    // Bounced
    if (selector.kind === "bounce-fallback") {
        ctx.append(`(${selfType}, ()) ${ops_1.ops.receiveBounceAny(self.name)}(${selfType} ${(0, id_1.funcIdOf)("self")}, slice ${(0, id_1.funcIdOf)(selector.name)}) impure inline {`);
        ctx.inIndent(() => {
            ctx.append(selfUnpack);
            for (const s of f.ast.statements) {
                (0, writeFunction_1.writeStatement)(s, selfRes, null, ctx);
    ...
    if (selector.kind === "bounce-binary") {
        const args = [
            ...
            (0, resolveFuncType_1.resolveFuncType)(selector.type, ctx, false, selector.bounced) +
                " " +
                (0, id_1.funcIdOf)(selector.name),
        ];
        ctx.append(`((${selfType}), ()) ${ops_1.ops.receiveTypeBounce(self.name, selector.type)}(${args.join(", ")}) impure inline {`);
        ctx.inIndent(() => {
            ctx.append(selfUnpack);
            ctx.append(`var ${(0, resolveFuncTypeUnpack_1.resolveFuncTypeUnpack)(selector.type, (0, id_1.funcIdOf)(selector.name), ctx, false, selector.bounced)} = ${(0, id_1.funcIdOf)(selector.name)};`);
            for (const s of f.ast.statements) {
                (0, writeFunction_1.writeStatement)(s, selfRes, null, ctx);
            }
            if (f.ast.statements.length === 0 ||
