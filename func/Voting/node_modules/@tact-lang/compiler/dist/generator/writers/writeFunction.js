...
function writeFunction(f, ctx) {
    ...
    switch (fAst.kind) {
        case "native_function_decl": {
            const name = (0, ast_1.idText)(fAst.nativeName);
        ...
        case "asm_function_def": {
            ...
            ctx.fun(name, () => {
                ...
                const asmShuffleEscaped = {
                    ...fAst.shuffle,
                    args: fAst.shuffle.args.map((id) => (0, ast_1.idOfText)((0, id_1.funcIdOf)(id))),
                };
                ctx.asm((0, prettyPrinter_1.prettyPrintAsmShuffle)(asmShuffleEscaped), fAst.instructions.join(" "));
            });
            if (f.isMutating) {
...
function writeNonMutatingFunction(f, name, params, returnsOriginal, markUsedName, ctx) {
    ...
    ctx.fun(nonMutName, () => {
        ...
        ctx.body(() => {
            ctx.append(`return ${(0, id_1.funcIdOf)("self")}~${markUsedName ? ctx.used(name) : name}(${f.ast.params
                .slice(1)
