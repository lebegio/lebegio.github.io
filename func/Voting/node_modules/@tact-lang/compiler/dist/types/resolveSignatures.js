    ...
    function createTupleSignature(name) {
        ...
        for (const field of t.fields.slice(0, -1)) {
            if (field.as === "remaining") {
                (0, errors_2.throwCompilationError)(`The "remainder" field can only be the last field of the struct`);
            }
        }
...
function newMessageOpcode(signature) {
    return {
        kind: "number",
        base: 10,
        value: BigInt((0, core_1.beginCell)()
            .storeBuffer((0, crypto_1.sha256_sync)(signature))
            .endCell()
            .beginParse()
            .loadUint(32)),
        id: 0,
