...
import { AstConstantDef, AstFunctionDef, AstContractInit, AstNativeFunctionDecl, AstReceiver, SrcInfo, AstTypeDecl, AstId, AstFunctionDecl, AstConstantDecl, AstFieldDecl, AstAsmFunctionDef, AstNumber } from "../grammar/ast";
...
export type Value = bigint | boolean | string | Address | Cell | Slice | null | CommentValue | StructValue;
export declare function showValue(val: Value): string;
