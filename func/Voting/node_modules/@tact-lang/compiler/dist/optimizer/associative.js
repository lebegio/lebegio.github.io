            ...
            if ((0, util_1.checkIsBinaryOp_With_RightValue)(topLevelNode.left) &&
                ...
                if (this.areAllowedOps([op1, op, op2]) &&
                    ...
                    try {
                        ...
                        const val = (0, interpreter_1.evalBinaryOp)(op2, (0, util_1.extractValue)(c1), (0, util_1.extractValue)(c2));
                        ...
                        const newLeft = optimizer.applyRules((0, util_1.makeBinaryExpression)(op1, x1, x2));
                        const newRight = (0, util_1.makeValueExpression)(val);
                        return (0, util_1.makeBinaryExpression)(op, newLeft, newRight);
                    }
                    catch (e) {
                ...
                if (this.areAllowedOps([op1, op, op2]) &&
                    ...
                    try {
                        // If an error occurs, we abandon the simplification
                        const val = (0, interpreter_1.evalBinaryOp)(op, (0, util_1.extractValue)(c1), (0, util_1.extractValue)(c2));
                        ...
                        // there is further opportunity of simplification,
                        // So, we ask the evaluator to apply all the rules in the subtree.
                        const newValNode = (0, util_1.makeValueExpression)(val);
                        const newLeft = optimizer.applyRules((0, util_1.makeBinaryExpression)(op1, x1, newValNode));
                        return (0, util_1.makeBinaryExpression)(op2, newLeft, x2);
                    }
                    catch (e) {
                        // Do nothing: will exit rule without modifying tree
                    }
                ...
                if (this.areAllowedOps([op1, op, op2]) &&
                    ...
                    try {
                        // If an error occurs, we abandon the simplification
                        const val = (0, interpreter_1.evalBinaryOp)(op, (0, util_1.extractValue)(c2), (0, util_1.extractValue)(c1));
                        // The current expression could be either
                        ...
                        // So, we ask the evaluator to apply all the rules in the subtree.
                        const newValNode = (0, util_1.makeValueExpression)(val);
                        const newLeft = optimizer.applyRules((0, util_1.makeBinaryExpression)(op2, x2, newValNode));
                        return (0, util_1.makeBinaryExpression)(op1, newLeft, x1);
                    }
                    catch (e) {
                        // Do nothing: will exit rule without modifying tree
                    }
                ...
                if (this.areAllowedOps([op1, op, op2]) &&
                    ...
                    try {
                        // If an error occurs, we abandon the simplification
                        const val = (0, interpreter_1.evalBinaryOp)(op1, (0, util_1.extractValue)(c1), (0, util_1.extractValue)(c2));
                        // The final expression is
                        // val op (x1 op2 x2)
                        // Because we are joining x1 and x2,
                        // there is further opportunity of simplification,
                        // So, we ask the evaluator to apply all the rules in the subtree.
                        const newRight = optimizer.applyRules((0, util_1.makeBinaryExpression)(op2, x1, x2));
                        const newLeft = (0, util_1.makeValueExpression)(val);
                        return (0, util_1.makeBinaryExpression)(op, newLeft, newRight);
                    }
                    catch (e) {
                        // Do nothing: will exit rule without modifying tree
...
class AssociativeRule2 extends AllowableOpRule {
    applyRule(ast, optimizer) {
        if ((0, util_1.checkIsBinaryOpNode)(ast)) {
            const topLevelNode = ast;
            if ((0, util_1.checkIsBinaryOp_With_RightValue)(topLevelNode.left) &&
                !(0, ast_1.isValue)(topLevelNode.right)) {
                // The tree has this form:
                // (x1 op1 c1) op x2
                const leftTree = topLevelNode.left;
                const rightTree = topLevelNode.right;
                ...
                if (this.areAllowedOps([op1, op]) &&
                    ...
                    // So, we ask the evaluator to apply all the rules in the subtree.
                    const newLeft = optimizer.applyRules((0, util_1.makeBinaryExpression)(op1, x1, x2));
                    return (0, util_1.makeBinaryExpression)(op, newLeft, c1);
                }
            }
            else if ((0, util_1.checkIsBinaryOp_With_LeftValue)(topLevelNode.left) &&
                !(0, ast_1.isValue)(topLevelNode.right)) {
                ...
                if (this.areAllowedOps([op1, op]) &&
                    ...
                    // there is further opportunity of simplification,
                    // So, we ask the evaluator to apply all the rules in the subtree.
                    const newRight = optimizer.applyRules((0, util_1.makeBinaryExpression)(op, x1, x2));
                    return (0, util_1.makeBinaryExpression)(op1, c1, newRight);
                }
            }
            else if (!(0, ast_1.isValue)(topLevelNode.left) &&
                (0, util_1.checkIsBinaryOp_With_RightValue)(topLevelNode.right)) {
                // The tree has this form:
                // x2 op (x1 op1 c1)
                const leftTree = topLevelNode.left;
                ...
                if (this.areAllowedOps([op, op1]) &&
                    ...
                    // there is further opportunity of simplification,
                    // So, we ask the evaluator to apply all the rules in the subtree.
                    const newLeft = optimizer.applyRules((0, util_1.makeBinaryExpression)(op, x2, x1));
                    return (0, util_1.makeBinaryExpression)(op1, newLeft, c1);
                }
            }
            else if (!(0, ast_1.isValue)(topLevelNode.left) &&
                (0, util_1.checkIsBinaryOp_With_LeftValue)(topLevelNode.right)) {
                ...
                if (this.areAllowedOps([op, op1]) &&
                    ...
                    // there is further opportunity of simplification,
                    // So, we ask the evaluator to apply all the rules in the subtree.
                    const newRight = optimizer.applyRules((0, util_1.makeBinaryExpression)(op1, x2, x1));
                    return (0, util_1.makeBinaryExpression)(op, c1, newRight);
                }
            }
        }
        // If execution reaches here, it means that the rule could not be applied fully
...
class AssociativeRule3 extends types_1.Rule {
    ...
    standardMultiplicativeCondition(c1, val_) {
        ...
        if ((0, util_1.sign)(c1) === (0, util_1.sign)(val_)) {
            return (0, util_1.abs)(c1) <= (0, util_1.abs)(val_);
        }
        else {
            return (0, util_1.abs)(c1) < (0, util_1.abs)(val_);
        }
        ...
        const plusLeftAssocOperators = new Map([
            [
                ...
                (x1, c1, c2) => {
                    ...
                    const val_ = (0, interpreter_1.evalBinaryOp)("+", c1, c2);
                    const val_node = (0, util_1.makeValueExpression)(val_);
                    return {
                        simplifiedExpression: (0, util_1.makeBinaryExpression)("+", x1, val_node),
                        safetyCondition: this.standardAdditiveCondition(c1, val_, 0n),
                    };
                },
            ],
            [
        ...
        const multiplyLeftAssocOperators = new Map([
            [
                ...
                (x1, c1, c2) => {
                    ...
                    return {
                        simplifiedExpression: (0, util_1.makeBinaryExpression)("*", x1, val_node),
                        safetyCondition: this.standardMultiplicativeCondition(c1, val_),
                    };
                },
            ],
        ]);
        ...
        const plusRightAssocOperators = new Map([
            [
                ...
                (x1, c1, c2) => {
                    ...
                    const val_ = (0, interpreter_1.evalBinaryOp)("+", c2, c1);
                    const val_node = (0, util_1.makeValueExpression)(val_);
                    return {
                        simplifiedExpression: (0, util_1.makeBinaryExpression)("+", val_node, x1),
                        safetyCondition: this.standardAdditiveCondition(c1, val_, 0n),
                    };
                },
            ],
            [
                ...
                (x1, c1, c2) => {
                    ...
                    return {
                        simplifiedExpression: (0, util_1.makeBinaryExpression)("-", val_node, x1),
                        safetyCondition: this.standardAdditiveCondition(c1, val_, -1n),
                    };
                },
            ],
        ]);
        ...
        const minusRightAssocOperators = new Map([
            [
                ...
                (x1, c1, c2) => {
                    ...
                    return {
                        simplifiedExpression: (0, util_1.makeBinaryExpression)("-", val_node, x1),
                        safetyCondition: this.oppositeAdditiveCondition(c1, val_, 0n),
                    };
                },
            ],
            [
                ...
                (x1, c1, c2) => {
                    ...
                    return {
                        simplifiedExpression: (0, util_1.makeBinaryExpression)("+", val_node, x1),
                        safetyCondition: this.oppositeAdditiveCondition(c1, val_, -1n),
                    };
                },
            ],
        ]);
        ...
        const minusRightCommuteOperators = new Map([
            ...
            [
                ...
                (x1, c1, c2) => {
                    ...
                    return {
                        simplifiedExpression: (0, util_1.makeBinaryExpression)("-", val_node, x1),
                        safetyCondition: this.shiftedAdditiveCondition(c1, val_),
                    };
                },
            ],
        ]);
        ...
        const andRightCommuteOperators = new Map([
            [
                ...
                (x1, c1, c2) => {
                    ...
                    if (c2 === true) {
                        // Final expression x1 && (c2 && c1)
                        final_expr = (0, util_1.makeBinaryExpression)("&&", x1, val_node);
                    }
                    else {
                        // Final expression (c2 && c1) && x1
                        // Note that by the safety condition,
                        // at this point c1 = true.
                        final_expr = (0, util_1.makeBinaryExpression)("&&", val_node, x1);
                    }
                    return {
    ...
    applyRule(ast, optimizer) {
        if ((0, util_1.checkIsBinaryOpNode)(ast)) {
            ...
            if ((0, util_1.checkIsBinaryOp_With_RightValue)(topLevelNode.left) &&
                ...
                const rightTree = topLevelNode.right;
                const x1 = leftTree.left;
                const c1 = (0, util_1.extractValue)(leftTree.right);
                const op1 = leftTree.op;
                const c2 = (0, util_1.extractValue)(rightTree);
                const op = topLevelNode.op;
                try {
                    const data = this.getLeftAssociativityTransform(op1, op)(x1, c1, c2);
                ...
                const rightTree = topLevelNode.right;
                const x1 = leftTree.right;
                const c1 = (0, util_1.extractValue)(leftTree.left);
                const op1 = leftTree.op;
                const c2 = (0, util_1.extractValue)(rightTree);
                const op = topLevelNode.op;
                try {
                    const data = this.getLeftCommutativityTransform(op1, op)(x1, c1, c2);
                    if (data.safetyCondition) {
                        // Since the tree is simpler now, there is further
                        // opportunity for simplification that was missed
                        // previously
                ...
                const rightTree = topLevelNode.right;
                const x1 = rightTree.left;
                const c1 = (0, util_1.extractValue)(rightTree.right);
                const op1 = rightTree.op;
                const c2 = (0, util_1.extractValue)(leftTree);
                const op = topLevelNode.op;
                try {
                    const data = this.getRightCommutativityTransform(op, op1)(x1, c1, c2);
                    if (data.safetyCondition) {
                        // Since the tree is simpler now, there is further
                        // opportunity for simplification that was missed
                        // previously
                ...
                const rightTree = topLevelNode.right;
                const x1 = rightTree.right;
                const c1 = (0, util_1.extractValue)(rightTree.left);
                const op1 = rightTree.op;
                const c2 = (0, util_1.extractValue)(leftTree);
                const op = topLevelNode.op;
                try {
                    const data = this.getRightAssociativityTransform(op, op1)(x1, c1, c2);
                    if (data.safetyCondition) {
                        // Since the tree is simpler now, there is further
                        // opportunity for simplification that was missed
                        // previously
