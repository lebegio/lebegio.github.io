import { AstModule, AstConstantDef, AstFunctionDef, AstNativeFunctionDecl, AstTypeDecl, AstAsmFunctionDef } from "./ast";
 ...
 * @public
 */
export declare function parseModules(sources: TactSource[]): AstModule[];
/**
...
export declare function openContext(ctx: CompilerContext, sources: TactSource[], funcSources: {
    code: string;
    path: string;
}[], parsedModules?: AstModule[]): CompilerContext;
